...
//implementing easy difficult to fix the settings
/// <summary>
/// The AIEasyPlayer is a type of AIPlayer where it will take random shots
/// </summary>
public class AIEasyPlayer : AIPlayer
{
    /// <summary>
    /// Private enumarator for AI states. There is one state for the Easy AI.
    /// The AI will constantly be searching for a ship, even if it has hit a ship
    /// </summary>
    ...
    protected override void GenerateCoords(ref int row, ref int column)
    {
        do
        {
            //check which state the AI is in and choose which coordinate generation
            //method will be used.
